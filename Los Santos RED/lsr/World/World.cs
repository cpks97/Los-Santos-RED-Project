...
namespace Mod
{
    public class World : IEntityLoggable, IEntityProvideable
    {
        ...
        private CayoProximityWatcher CayoProximityWatcher;
        ...
        public void Setup(IInteractionable player, ILocationInteractable locationInteractable)
        {
            ...
            CayoProximityWatcher = new CayoProximityWatcher(locationInteractable, PlacesOfInterest, this, ModDataFileManager.ModItems, Settings, Weapons, Time);
            CayoProximityWatcher.Setup();
        }
