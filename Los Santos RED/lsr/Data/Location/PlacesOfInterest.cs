...
public class PlacesOfInterest : IPlacesOfInterest
{
    ...
    private void DefaultConfig_ClothingShops()
    {
        ClothingShops = new List<ClothingShop>()
        {
                ...
                new ClothingShop(new Vector3(618.1257f, 2750.503f, 42.08913f), 182.7492f, "Suburban Harmony","Low-quality clothing at low prices.","SuburbanClothesMenu")
                {
                    ...
                    PedClothingShopMenuID = "SuburbanClothesMenu",
                },
                new ClothingShop(new Vector3(127.2656f, -210.8601f, 54.53394f), 343.5752f, "Suburban Hawick","Low-quality clothing at low prices.","SuburbanClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 19458,
                ...
                new ClothingShop(new Vector3(-1201.583f, -777.7266f, 17.33841f), 124.1612f, "Suburban Del Perro","Low-quality clothing at low prices.","SuburbanClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 10754,
                ...
                new ClothingShop(new Vector3(-3168.233f, 1056.191f, 20.85903f), 336.1733f, "Suburban Chumash","Low-quality clothing at low prices.","SuburbanClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 87554,
                ...
                new ClothingShop(new Vector3(-1.203748f, 6516.808f, 31.86886f), 43.96292f,"Discount Store Paleto Bay","A fresh fashion look every day.","DiscountStoreClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 74754,
                    ...
                    DisableRegularInteract = true,
                    VendorPersonnelID = "TellerPeds",
                    PedClothingShopMenuID = "DiscountStoreClothesMenu",
                },
                new ClothingShop(new Vector3(82.68394f, -1391.648f, 29.40018f), 268.6164f,"Discount Store Strawberry","A fresh fashion look every day.","DiscountStoreClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 88066,
                ...
                new ClothingShop(new Vector3(-1095.588f, 2705.948f, 19.08581f), 225.1095f,"Discount Store Great Chaparral","A fresh fashion look every day.","DiscountStoreClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 66562,
                ...
                new ClothingShop(new Vector3(1198.071f, 2702.92f, 38.15594f), 177.9302f,"Discount Store Harmony","A fresh fashion look every day.","DiscountStoreClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 118274,
                ...
                new ClothingShop(new Vector3(1686.742f, 4820.526f, 41.97639f), 98.08424f,"Discount Store Grapeseed","A fresh fashion look every day.","DiscountStoreClothesMenu")
                {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 60930,
                ...
                new ClothingShop(new Vector3(417.8476f, -807.7466f, 29.39305f), 92.20033f, "Binco Textile City","Low-quality clothing at low prices.","BincoClothesMenu")
                {
                    ...
                    DisableRegularInteract = true,
                    VendorPersonnelID = "TellerPeds",
                    PedClothingShopMenuID = "BincoClothesMenu",
                },
                new ClothingShop(new Vector3(-817.3553f, -1079.649f, 11.13252f), 211.1177f, "Binco Vespucci Canals","Low-quality clothing at low prices.","BincoClothesMenu")
                {
                ...
                new ClothingShop(new Vector3(-717.36f, -157.29f, 38.2f), 117.6851f, "Ponsonbys Rockford Hills","Catering to the Elite","PoisonbysClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 14338,
                    DisableRegularInteract = true,
                    ...
                    VendorPersonnelID = "TellerPeds",
                    PedClothingShopMenuID = "PoisonbysClothesMenu",
                    VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-708.7365f, -151.7497f, 37.41513f), 113.7162f) },
                },
                new ClothingShop(new Vector3(-156.4988f, -305.4473f, 39.73074f), 242.0752f, "Ponsonbys Burton","Catering to the Elite","PoisonbysClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 6914,
                    DisableRegularInteract = true,
                ...
                new ClothingShop(new Vector3(-1455.754f, -232.4616f, 49.7874f), 45.15975f, "Ponsonbys Morningwood","Catering to the Elite","PoisonbysClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    InteriorID = 1282,
                    DisableRegularInteract = true,
                ...
                //NO DEFUALT INTERIOR
                new ClothingShop(new Vector3(-1216.509f, -764.6811f, 18.46337f), 125.2499f, "Didier Sachs Del Perro","Fashion never cost so much","DidierSachsClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    DisableRegularInteract = true,
                    InteriorID = -19999,
                    VendorPersonnelID = "TellerPeds",
                    PedClothingShopMenuID = "DidierSachsClothesMenu",
                },
                new ClothingShop(new Vector3(-250.3629f, -954.3096f, 31.22f), 247.3126f, "Didier Sachs Pillbox Hill","Fashion never cost so much","DidierSachsClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    DisableRegularInteract = true,
                    InteriorID = -20000,
                ...
                new ClothingShop(new Vector3(-855.7509f, -364.0399f, 38.68024f), 203.7949f, "Didier Sachs IOU Building","Fashion never cost so much","DidierSachsClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    DisableRegularInteract = true,
                    InteriorID = -20001,
                ...
                new ClothingShop(new Vector3(-837.588f, -161.6364f, 37.90956f), 0f, "Didier Sachs Portla Drive","Fashion never cost so much","DidierSachsClothesMenu") {
                    OpenTime = 8,
                    CloseTime = 20,
                    DisableRegularInteract = true,
                    InteriorID = -20002,
    ...
    private void DefaultConfig_Bars()
    {
        Bars = new List<Bar>()
        {
            ...
            new Bar(new Vector3(1982.979f, 3053.596f, 47.21508f), 226.3188f, "Yellow Jacket Inn", "","BarMenu") { ActivateDistance = 75f, VendorFightPercentage = 45f,VendorFightPolicePercentage = 10f, OpenTime = 0, CloseTime = 24,VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(1982.979f, 3053.596f, 47.21508f), 226.3188f) }, ScannerFilePath = "01_specific_location\\0x02C36B8B.mp3",VendorPersonnelID = "BarPeds",  },
    ...
    private void DefaultConfig_GasStations()//VendorLocations = new List<SpawnPlace>() { new SpawnPlace() },
    {
        ...
        {
            new GasStation(new Vector3(-711.9264f, -917.7573f, 19.21472f), 180.3014f, "LtD", "unLTD great prices!","LTDMenu"){ ActivateDistance = 75f, BannerImagePath = "stores\\ltd.png",VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-705.7453f, -913.6598f, 19.21559f), 83.75771f) },OpenTime = 0, CloseTime = 24, InteriorID = 47874 },
            new GasStation(new Vector3(1698.097f, 4929.837f, 42.0781f), 48.2484f, "LtD", "unLTD great prices!","LTDMenu"){ ActivateDistance = 75f, BannerImagePath = "stores\\ltd.png",VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(1698.044f, 4922.526f, 42.06367f), 314.3236f) },OpenTime = 0, CloseTime = 24, InteriorID = 45570 },
            ...
            new GasStation(new Vector3(1159.861f, -327.4188f, 69.21286f), 188.791f, "LtD","unLTD great prices!","LTDMenu"){ ActivateDistance = 75f, BannerImagePath = "stores\\ltd.png",VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(1165.12f, -322.5843f, 68.80514f), 98.88105f) },OpenTime = 0, CloseTime = 24, InteriorID = 2050, },



            new GasStation(new Vector3(-1817.871f,787.0063f,137.917f), 89.38248f, "LtD","unLTD great prices!","LTDMenu"){ ActivateDistance = 75f, BannerImagePath = "stores\\ltd.png",OpenTime = 0, CloseTime = 24, InteriorID = 82178,VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-1819.707f, 794.1723f, 138.0823f),122.8981f) },   },
    ...
    private void DefaultConfig_LiquorStores()
    {
        ...
        {
            new LiquorStore(new Vector3(-1226.09f, -896.166f, 12.4057f), 22.23846f, "Rob's Liquors","Thats My Name, Don't Rob Me!","LiquorStoreMenu") { ActivateDistance = 75f, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-1221.119f, -908.5667f, 12.32635f),33.35855f) },OpenTime = 4, CloseTime = 22, InteriorID = 50178 },
            new LiquorStore(new Vector3(-2974.098f, 390.9085f, 15.03413f), 84.05217f, "Rob's Liquors", "Thats My Name, Don't Rob Me!","LiquorStoreMenu"){ ActivateDistance = 75f, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-2966.361f, 390.1463f, 15.04331f), 88.73301f) },OpenTime = 4, CloseTime = 22, InteriorID = 19202 },
            new LiquorStore(new Vector3(-1491.638f, -384.0242f, 40.08308f), 136.3043f, "Rob's Liquors", "Thats My Name, Don't Rob Me!","LiquorStoreMenu") { ActivateDistance = 75f, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-1486.196f, -377.7115f, 40.16343f), 133.357f) },OpenTime = 4, CloseTime = 22, InteriorID = 98818 },
            new LiquorStore(new Vector3(1141.463f, -980.9073f, 46.41084f), 275.826f,"Rob's Liquors", "Thats My Name, Don't Rob Me!","LiquorStoreMenu"){ ActivateDistance = 75f, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(1133.534f, -983.1248f, 46.41584f), 276.1162f) },OpenTime = 4, CloseTime = 22, InteriorID = 73986 },
            new LiquorStore(new Vector3(1166.318f, 2702.173f, 38.17925f), 175.7192f, "Scoops Liquor Barn", "We've got the scoop on booze","LiquorStoreMenu"){ ActivateDistance = 75f, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(1165.581f, 2710.774f, 38.15771f), 176.1093f) },OpenTime = 4, CloseTime = 22, InteriorID = 33026 },
    ...
    private void DefaultConfig_ConvenienceStores()
    {
        ...
        {
            new ConvenienceStore(new Vector3(547f, 2678f, 42.1565f), 22.23846f,  "24/7","As fast as you","TwentyFourSevenMenu"){ ActivateDistance = 75f, OpenTime = 0, CloseTime = 24,BannerImagePath = "stores\\247.png", InteriorID = 41474, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(549.6005f, 2669.846f, 42.1565f), 96.91093f) },},
            new ConvenienceStore(new Vector3(-3236.767f,1005.609f,12.33137f), 122.6316f,  "24/7","As fast as you","TwentyFourSevenMenu"){ ActivateDistance = 75f, OpenTime = 0, CloseTime = 24,BannerImagePath = "stores\\247.png", InteriorID = 16386, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-3243.302f, 1000.005f, 12.83071f), 352.6259f) }, },
            new ConvenienceStore(new Vector3(2560f, 385f, 108f), 22.23846f,  "24/7","As fast as you","TwentyFourSevenMenu"){ ActivateDistance = 75f, OpenTime = 0, CloseTime = 24,BannerImagePath = "stores\\247.png", InteriorID = 62722, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(2555.339f, 380.9034f, 108.6229f), 347.3629f) }, },
            new ConvenienceStore(new Vector3(29.32254f, -1350.485f, 29.33319f), 170.9901f,  "24/7", "As fast as you","TwentyFourSevenMenu"){ ActivateDistance = 75f, OpenTime = 0, CloseTime = 24,BannerImagePath = "stores\\247.png", InteriorID = 33282, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(24.39647f, -1345.484f, 29.49702f), 252.9084f) }, },
            new ConvenienceStore(new Vector3(-3037.729f, 589.7671f, 7.814812f), 289.0175f,  "24/7", "As fast as you","TwentyFourSevenMenu"){ ActivateDistance = 75f, OpenTime = 0, CloseTime = 24,BannerImagePath = "stores\\247.png", InteriorID = 97538, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-3039.787f, 584.1979f, 7.908929f), 12.80189f) }, },
            ...
            new ConvenienceStore(new Vector3(2682.938f, 3282.287f, 55.24056f), 243.885f,  "24/7", "As fast as you","TwentyFourSevenMenu") { ActivateDistance = 75f, OpenTime = 0, CloseTime = 24 ,BannerImagePath = "stores\\247.png", InteriorID = 13826, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(2676.595f, 3280.101f, 55.24113f), 325.0921f) },},
            ...
            new ConvenienceStore(new Vector3(1965.801f, 3739.945f, 32.322f), 207.564f,  "24/7","As fast as you","TwentyFourSevenMenu") { ActivateDistance = 75f, OpenTime = 0, CloseTime = 24,BannerImagePath = "stores\\247.png", InteriorID = 55554, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(1959.352f, 3741.18f, 32.34374f), 303.8849f) }, },
            new ConvenienceStore(new Vector3(-53.5351f, -1757.196f, 29.43954f), 146.0623f,  "LtD", "unLTD great prices!","LTDMenu"){ ActivateDistance = 75f, BannerImagePath = "stores\\ltd.png",OpenTime = 0, CloseTime = 24, InteriorID = 80642, VendorLocations = new List<SpawnPlace>() { new SpawnPlace(new Vector3(-45.89098f, -1757.345f, 29.42101f), 52.66933f) }, },
    ...
    private void DefaultConfig_Residences()
    {
        Residences = new List<Residence>()
        {
            ...
            //new Residence(new Vector3(-773.63f, 313.08f, 85.70f), 180f, "Eclipse Towers Apt 401",""){ InteriorID = -669,OpenTime = 0,CloseTime = 24,RentalFee = 30000, RentalDays = 1,PurchasePrice = 2000000,SalesPrice = 1500000,},
            new Residence(new Vector3(77.15f, -871.53f, 31.51f), 65f, "Elgin Ave Apt 340",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1},
            new Residence(new Vector3(-390.3866f, -187.2812f, 37.3177f), 207.2874f, "70W Carcer Way Apt 343",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,},
            new Residence(new Vector3(76.05615f, -86.96131f, 63.00647f), 249.8842f, "1144 Apartment 2B", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 380000,SalesPrice = 290000, RentalDays = 1, RentalFee = 3000  },
            new Residence(new Vector3(-37.54279f, 170.3245f, 95.35922f), 303.8834f, "Elgin House Apartment 23E", "") { InteriorID = 108290, OpenTime = 0,CloseTime = 24, PurchasePrice = 404000,SalesPrice = 350000, RentalDays = 1, RentalFee = 3000  },
            new Residence(new Vector3(9.063264f, 52.93087f, 71.64354f), 344.3057f, "0605 Apartment 4F", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 375000,SalesPrice = 280000, RentalDays = 1, RentalFee = 3000  },
            new Residence(new Vector3(-780.21f, -784.22f, 27.87f), 85f, "Dream Tower Apt 31",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1},
            new Residence(new Vector3(-116.35f, -37.69f, 62.20f), 70f, "Las Lagunas Blvd Apt 21",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1},
            new Residence(new Vector3(-766.33f, -917.05f, 21.28f), 270f, "1068 Ginger St. Apt 4",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 350000,SalesPrice = 300000,},
            new Residence(new Vector3(-131.3305f, -1665.597f, 32.56437f), 316.4919f, "20W Strawberry Apt 2", ""){ InteriorID = 60162,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,},
            new Residence(new Vector3(-114.5114f, -1660.003f, 32.56433f), 52.34958f, "20W Strawberry Apt 1", ""){ InteriorID = 60162,OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,},
            ...
            new Residence(new Vector3(-59.58021f, -617.4625f, 37.35678f), 69.24533f, "4 Integrity Way, Apt 28",""){
                InteriorID = 21250, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 1, IsOnMPMap = false
            ...
            new Residence(new Vector3(-59.58021f, -617.4625f, 37.35678f), 69.24533f, "4 Integrity Way, Apt 30",""){
                InteriorID = 47362, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 2, IsOnMPMap = false
            , CameraPosition = new Vector3(-103.6068f, -621.355f, 61.43004f), CameraDirection = new Vector3(0.9355325f, 0.094497f, -0.3403665f), CameraRotation = new Rotator(-19.89921f, -2.269968E-07f, -84.23219f)},

            new Residence(new Vector3(-1442.846f, -544.5376f, 34.74181f), 213.3763f, "Del Perro Heights, Apt 4",""){
                InteriorID = 76290, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 3, IsOnMPMap = false },

            new Residence(new Vector3(-1442.846f, -544.5376f, 34.74181f), 213.3763f, "Del Perro Heights, Apt 7",""){
                InteriorID = -673, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 4, IsOnMPMap = false, },

            new Residence(new Vector3(-773.63f, 313.08f, 85.70f), 180f, "Eclipse Towers, Apt 3",""){
                InteriorID = 61186, IsOnMPMap = false, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 5 },
            //new Residence(new Vector3(-773.63f, 313.08f, 85.70f), 180f, "Eclipse Towers, Apt 3",""){
            //    InteriorID = -674, IsOnSPMap = false, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 6 },

            new Residence(new Vector3(-936.8324f, -379.2408f, 38.96133f), 113.6606f, "Richard Majestic, Apt 2",""){
                InteriorID = -675, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 7 },
            //
            new Residence(new Vector3(-593.1158f, 37.89521f, 43.60775f), 179.0897f, "Tinsel Towers, Apt 42",""){
                InteriorID = 90882, IsOnMPMap = false, OpenTime = 0,CloseTime = 24,RentalFee = 3000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,HasHeaderApartmentBuilding = true,ResidenceID = 8 },
            ...
            //NEW
            //Vespucci
            new Residence(new Vector3(-1035.18f, -1146.53f, 2.16f), 32.45f, "68 Vespucci Canals", "") { InteriorID = 108290, OpenTime = 0,CloseTime = 24, PurchasePrice = 450000, SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-960.14f, -1109.21f, 2.15f), 33.94f, "87 Vespucci Canals", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 380000, SalesPrice = 300000,RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-951.51f, -1078.93f, 2.15f), 207.97f, "88 Vespucci Canals", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 490000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-1183.19f, -1064.55f, 2.15f), 114.64f, "42 Vespucci Canals", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 300000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-983.25f, -1065.88f, 2.15f), 30.08f, "86 Vespucci Canals", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 440000,SalesPrice = 300000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-1064.27f, -1159.15f, 2.16f), 31.65f, "65 Vespucci Canals", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 300000, RentalDays = 1, RentalFee = 1000  },
            
            //Mirror Park
            new Residence(new Vector3(987.9448f, -525.9558f, 60.69062f), 208.7025f, "114 Nikola Ave", "") { InteriorID = 55042, OpenTime = 0,CloseTime = 24, PurchasePrice = 390000,SalesPrice = 310000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(976.0329f, -579.8205f, 59.63558f), 30.60654f, "115 Nikola Ave", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 360000,SalesPrice = 300000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(1323.468f, -583.0522f, 73.24638f), 334.7151f, "104 East Mirror Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 480000,SalesPrice = 360000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(1372.544f, -555.1687f, 74.68565f), 153.1011f, "107 East Mirror Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 500000,SalesPrice = 380000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(999.5336f, -593.9052f, 59.63857f), 259.7758f, "93 Mirror Pl", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 270000,SalesPrice = 210000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(979.8713f, -627.104f, 59.23589f), 124.2795f, "218 West Mirror Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },

            new Residence(new Vector3(1060.462f, -378.1198f, 68.23125f), 229.2095f, "112 Bridge St", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 350000,SalesPrice = 310000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(1051.598f, -470.5955f, 63.91349f), 257.9751f, "118 Bridge St", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 335000,SalesPrice = 300000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(1090.538f, -484.3305f, 65.66045f), 76.35575f, "117 Bridge St", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 400000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },

            //Apartments
            new Residence(new Vector3(-1150.072f, -1521.705f, 10.62806f), 225.8192f, "7611 Goma St", "") { DisableInteractAfterPurchase = true, OpenTime = 0,CloseTime = 24, InteriorID = 24578, PurchasePrice = 550000,SalesPrice = 390000, RentalDays = 1, RentalFee = 1000 },

            //House
            new Residence(new Vector3(983.7811f, 2718.655f, 39.50342f), 175.7726f, "345 Route 68", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 234000,SalesPrice = 190000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(980.1745f, 2666.563f, 40.04342f), 1.699184f, "140 Route 68", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 225000,SalesPrice = 180000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-3030.045f, 568.7484f, 7.823583f), 280.3508f, "566 Ineseno Rd", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 556000,SalesPrice = 320000, RentalDays = 1, RentalFee = 1000 },
            new Residence(new Vector3(-3031.865f, 525.1087f, 7.424246f), 267.6694f, "800 Ineseno Rd", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 467000,SalesPrice = 310000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-3039.567f, 492.8512f, 6.772703f), 226.448f, "805 Ineseno Rd", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 450000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(195.0935f, 3031.064f, 43.89068f), 273.1078f, "125 Joshua Rd", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 298000,SalesPrice = 210000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(191.0053f, 3082.26f, 43.47285f), 277.6117f, "610N Joshua Rd", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 289000,SalesPrice = 200000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(241.7666f, 3107.666f, 42.48719f), 93.76467f, "620N Joshua Rd", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 275000,SalesPrice = 190000, RentalDays = 1, RentalFee = 1000  },
            //new Residence(new Vector3(162.8214f, 3119.749f, 43.42594f), 192.0786f, "621N Joshua Rd", "") { InteriorID = 108290, OpenTime = 0,CloseTime = 24, PurchasePrice = 57000,SalesPrice = 35000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(247.5913f, 3169.535f, 42.78756f), 90.61945f, "630N Joshua Rd", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 267000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-272.7155f, 6400.906f, 31.50496f), 215.1084f, "1275N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 470000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-247.7424f, 6370.079f, 31.84554f), 45.0573f, "1276N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 476000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-227.3544f, 6377.188f, 31.75924f), 47.93699f, "1278N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 414000,SalesPrice = 320000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-245.4691f, 6413.878f, 31.4606f), 130.3203f, "1281N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 455000,SalesPrice = 330000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-213.7807f, 6395.94f, 33.08509f), 40.99633f, "1282N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 435000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-189.0498f, 6409.355f, 32.29676f), 48.98f, "1285N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 445000,SalesPrice = 350000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-280.4388f, 6350.718f, 32.60079f), 24.08426f, "1271N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 247000,SalesPrice = 210000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-359.5872f, 6334.424f, 29.84736f), 226.0376f, "1260N Procopio Dr", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 565000,SalesPrice = 450000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-332.7523f, 6301.959f, 33.08874f), 69.82259f, "1262N Procopio Dr", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 257000,SalesPrice = 240000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-407.2561f, 6314.223f, 28.94128f), 230.5133f, "1259N Procopio Dr", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 414000,SalesPrice = 390000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(-437.4564f, 6261.807f, 30.06895f), 228.8042f, "1252N Procopio Dr", "") { InteriorID = 108290,OpenTime = 0,CloseTime = 24, PurchasePrice = 520000,SalesPrice = 410000, RentalDays = 1, RentalFee = 1000  },
            new Residence(new Vector3(1880.423f, 3921.08f, 33.21722f), 100.0703f, "785N Niland Ave", "") { InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 224000,SalesPrice = 210000, RentalDays = 1, RentalFee = 1000  },

            new Residence(new Vector3(1683.038f, 4689.635f, 43.06602f), 269.7168f, "330E Grapeseed", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 200000,SalesPrice = 150000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(1674.201f, 4658.228f, 43.37114f), 270.4372f, "335E Grapeseed", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 200000,SalesPrice = 150000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(1725.289f, 4642.35f, 43.87548f), 115.7792f, "340E Grapeseed", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 250000,SalesPrice = 150000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(1881.219f, 3810.713f, 32.77882f), 301.1151f, "370E Niland ", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 150000,SalesPrice = 90000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(1899.071f, 3781.417f, 32.8769f), 299.5774f, "380E Niland", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 175000,SalesPrice = 150000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(-3186.93f, 1274.122f, 12.66124f), 257.7415f, "630W Barbareno", ""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,PurchasePrice = 750000,SalesPrice = 650000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(-3194.785f, 1179.539f, 9.659509f), 258.9255f, "632W Barbareno", ""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,PurchasePrice = 650000,SalesPrice = 550000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(-3238.444f, 952.556f, 13.34334f), 281.2452f, "642W Barbareno", ""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,PurchasePrice = 670000,SalesPrice = 550000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(-3093.812f, 349.4576f, 7.544847f), 258.988f, "611W Ineseno", ""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,PurchasePrice = 1200000,SalesPrice = 980000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(312.721f, -1956.719f, 24.42436f), 229.223f, "61E Jamestown ", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 330000,SalesPrice = 280000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(256.5888f, -2023.559f, 19.26631f), 227.9232f, "50E Jamestown", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 400000,SalesPrice = 320000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(165.2183f, -1944.738f, 20.23543f), 228.8544f, "30E Roy Lowenstein", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 425000,SalesPrice = 330000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(150.2098f, -1864.915f, 24.59134f), 153.5939f, "20E Covenant", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 250000,SalesPrice = 190000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(114.7368f, -1887.42f, 23.92823f), 333.4948f, "21E Covenant", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,PurchasePrice = 275000,SalesPrice = 180000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(54.01227f, -1873.436f, 22.80583f), 128.9813f, "10E Grove Street", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 225000,SalesPrice = 170000, RentalFee = 1000, RentalDays = 1,},
            new Residence(new Vector3(-5.184085f, -1871.247f, 24.15101f), 317.3572f, "3E Grove St", ""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24, PurchasePrice = 325000,SalesPrice = 270000, RentalFee = 1000, RentalDays = 1,},

            new Residence(new Vector3(-64.19335f, -1450.097f, 32.52492f), 188.7294f, "280S Forum Dr No 1",""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,},//lamar house
            new Residence(new Vector3(863.4708f, -1585.503f, 31.4171f), 89.42107f, "310S Popular Street",""){ InteriorID = 60162,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,},//lamar house

            new Residence(new Vector3(-1597.134f, -352.3153f, 45.97645f), 230.207f, "Pacific Buff Manor",""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 1200000,SalesPrice = 980000,},

            //from box in discord
            new Residence(new Vector3(-188.97f, 1008.84f, 232.13f), 87f, "202 Lake Vinewood Estate",""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 1550000,SalesPrice = 1200000,},
            new Residence(new Vector3(-232.71f, 588.12f, 190.54f), 355f, "3636 Kimble Hill Dr",""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 1250000,SalesPrice = 900000,},
            new Residence(new Vector3(-700.87f, 649.99f, 155.38f), 350f, "4057 Hillcrest Ave",""){ InteriorID = 55042,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 1100000,SalesPrice = 980000,},
            new Residence(new Vector3(-1009.54f, 479.05f, 79.60f), 330f, "2125 Cockingend Dr",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 1800000,SalesPrice = 1200000,},
            new Residence(new Vector3(1289.23f, -1710.51f, 55.48f), 205f, "412 El Burro Heights",""){ InteriorID = 108290,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 200000,SalesPrice = 180000,},
            new Residence(new Vector3(-1243.89f, -1241.10f, 11.03f), 20f, "1533 Magellan Ave",""){ InteriorID = 60162,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1},

            //MP Houses with Interiors
            new Residence(new Vector3(346.3378f,440.5709f, 147.8333f),292.537f,"2044 North Conker Avenue","") { InteriorID = 206081, IsOnSPMap = false,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 762000, SalesPrice = 381000, },
            new Residence(new Vector3(373.9571f,427.8646f, 145.6842f),41.48535f,"2045 North Conker Avenue","") { InteriorID = 206337, IsOnSPMap = false,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 727000, SalesPrice = 363500, },
            new Residence(new Vector3(-174.7182f,502.512f, 137.4203f),79.66186f,"3655 Wild Oats Drive","") { InteriorID = 207105, IsOnSPMap = false,OpenTime = 0,CloseTime = 24,RentalFee = 1000, RentalDays = 1,PurchasePrice = 800000, SalesPrice = 400000, },
